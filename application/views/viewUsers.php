                           ...
                           foreach($users as $user){
                               ?>
                                    <tr>
                                        ...
                                        <td><?= $user['username']?></td>
                                        <td><?= $user['email']?></td>
                                        <td><?= $user['added_time']?></td>
                                        <td><a href="<?php echo  base_url('/signup/edit/'.$user['userId'])?>"><box-icon id="edit" type='solid' name='edit-alt'></box-icon></a></td>
                                        <td><a href="<?php echo  base_url('/users/delete/'.$user['userId'])?>"><box-icon id="delete" type='solid' name='trash'></box-icon></a></td>
                                    </tr>
                               <?php
                           }
                       } else {?>
