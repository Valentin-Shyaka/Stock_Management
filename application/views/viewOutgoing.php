                           ...
                           foreach($outgoing as $outgoing){
                               ?>
                                    <tr>
                                        ...
                                        <td><?= $outgoing['productId']?></td>
                                        <td><?= $outgoing['quantity']?></td>
                                        <td><?= $outgoing['added_date']?></td>
                                        <td><a href="<?php echo  base_url()?>"><box-icon id="edit" type='solid' name='edit-alt'></box-icon></a></td>
                                        <td><a href="http://"><box-icon id="delete" type='solid' name='trash'></box-icon></a></td>
                                    </tr>
                               <?php
                           }
                       } else {
