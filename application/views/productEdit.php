...
<section class="product">
   ...
   <?php
echo form_open('/products/updateProduct/'.$product->productId, array("method"=>"post"));
?>
   <div class="prod-form row">
   <div class="form-field col-lg-12">
         <input id="message" class="input-text js-input" type="text" value="<?= $product->product_Name?>" name="productname" required>
         <label class="label" for="message">Product name</label>
    </div>
    <div class="form-field col-lg-12">
         <input id="message" class="input-text js-input" type="text" value="<?= $product->brand?>"  name="brand" required>
         <label class="label" for="message">Brand</label>
    </div>
    <div class="form-field col-lg-12">
         <input id="message" class="input-text js-input" type="text" value="<?= $product->supplier_phone?>"  name="supplier_phone" required>
         <label class="label" for="message">Supplier phone</label>
    </div>
    <div class="form-field col-lg-12">
         <input id="message" class="input-text js-input" type="text" value="<?= $product->supplier?>"  name="supplier" required>
