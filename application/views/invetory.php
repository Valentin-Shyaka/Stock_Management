...
.invent-form .input-text:focus {
  outline: none;
}
.invent-form .input-text:focus + .label,
.invent-form .input-text.not-empty + .label {
   ...
   <form class="invent-form row">
      ...
      <div class="form-field col-lg-12">
          <p>
                    ...
                    <select id="name" class="input-text js-input" type="text" name="product_id" required>
